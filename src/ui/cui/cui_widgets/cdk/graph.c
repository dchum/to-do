...
DeclareCDKWidgets (GRAPH, Graph, setCdk, Unknown);
		       ...
		       const char *ytitle)
{
   ...
   if ((widget = newCDKWidget (CDKGRAPH, &my_funcs)) == NULL)
        return (NULL);
   ...
   registerCDKWidget (cdkscreen, vGRAPH, widget);
...
static void _destroyCDKGraph (CDKOBJS *object)
{
   if (object != NULL)
   {
      ...
      cleanCDKWidgetBindings (vGRAPH, widget);

      /* Unregister this object. */
      unregisterCDKWidget (vGRAPH, widget);
