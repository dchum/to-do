 ...
 * Notes:
 *
 * The cdktype parameter passed to bindCDKWidget, etc., is redundant since
...
static CDKOBJS *bindableWidget (EWidgetType * cdktype, void *object)
{
 ...
 */
void bindCDKWidget (EWidgetType cdktype,
		    void *object,
		    chtype key,
		    BINDFN function,
		    void *data)
{
   CDKOBJS *obj = bindableWidget (&cdktype, object);
 ...
 */
void unbindCDKWidget (EWidgetType cdktype, void *object, chtype key)
{
   CDKOBJS *obj = bindableWidget (&cdktype, object);
 ...
 */
void cleanCDKWidgetBindings (EWidgetType cdktype, void *object)
{
   CDKOBJS *obj = bindableWidget (&cdktype, object);
 ...
 * bindings.
 */
int checkCDKWidgetBind (EWidgetType cdktype, void *object, chtype key)
{
   CDKOBJS *obj = bindableWidget (&cdktype, object);
 ...
 * This checks to see if the binding for the key exists.
 */
bool isCDKWidgetBind (EWidgetType cdktype, void *object, chtype key)
{
   bool result = FALSE;
   CDKOBJS *obj = bindableWidget (&cdktype, object);
 ...
 * a distinct address.
 */
int getcCDKBind (EWidgetType cdktype GCC_UNUSED,
 ...
 */
int getcCDKWidget (CDKOBJS *obj)
{
   EWidgetType cdktype = ObjTypeOf (obj);
   CDKOBJS *test = bindableWidget (&cdktype, obj);
