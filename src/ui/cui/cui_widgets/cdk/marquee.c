...
DeclareCDKWidgets (MARQUEE, Marquee, setCdk, Unknown);
			   ...
			   boolean shadow)
{
   ...
   if ((widget = newCDKWidget (CDKMARQUEE, &my_funcs)) == NULL)
        return (NULL);
   ...
   registerCDKWidget (cdkscreen, vMARQUEE, widget);
...
static void _destroyCDKMarquee (CDKOBJS *object)
{
   if (object != NULL)
   {
      ...
      cleanCDKWidgetBindings (vMARQUEE, widget);

      /* Unregister this object. */
      unregisterCDKWidget (vMARQUEE, widget);
   }
}
