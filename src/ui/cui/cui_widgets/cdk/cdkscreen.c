...
static boolean validObjType(CDKOBJS *obj, EWidgetType type)
{
   bool valid = FALSE;
 ...
 */
bool validCDKWidget(CDKOBJS *obj)
{
   bool result = FALSE;
   if (obj != NULL)
   {
 ...
 */
void *_newCDKWidget(unsigned size, const CDKFUNCS *funcs)
{
   ALL_OBJECTS *item;
   CDKOBJS *result = NULL;
...
void _destroyCDKWidget(CDKOBJS *obj)
{

   if (validCDKWidget(obj))
   {
      ALL_OBJECTS *p, *q;
 ...
 */
void registerCDKWidget(CDKSCREEN *screen, EWidgetType cdktype, void *object)
{
 ...
 * This registers a CDK object with a screen.
 */
void reRegisterCDKWidget(EWidgetType cdktype, void *object)
{
   CDKOBJS *obj = (CDKOBJS *)object;

   registerCDKWidget(obj->screen, cdktype, object);
}

/*
 * This removes an object from the CDK screen.
 */
void unregisterCDKWidget(EWidgetType cdktype, void *object)
{
   CDKOBJS *obj = (CDKOBJS *)object;
 ...
 */
void raiseCDKWidget(EWidgetType cdktype, void *object)
{
   CDKOBJS *obj = (CDKOBJS *)object;
 ...
 */
void lowerCDKWidget(EWidgetType cdktype, void *object)
{
   CDKOBJS *obj = (CDKOBJS *)object;
...
void eraseCDKScreen(CDKSCREEN *cdkscreen)
{
   ...
   /* We just call the drawWidget function. */
   for (x = 0; x < objectCount; x++)
   {
      CDKOBJS *obj = cdkscreen->object[x];
 ...
 */
void destroyCDKScreenWidgets(CDKSCREEN *cdkscreen)
{
   int x;
