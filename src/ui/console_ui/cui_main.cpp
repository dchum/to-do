...
CUI_Imp* CUI_Factory_UI_Imp::imp_ = nullptr;

class CUI_Imp: public ui::Ui_Imp
{
private:
    Widget* wdts_;
...
CUI_Factory_UI_Imp::CUI_Factory_UI_Imp()
{
    if ( imp_ == nullptr )
    {
        imp_ = new CUI_Imp;
...
ui::Ui_Imp *CUI_Factory_UI_Imp::get_imp(void)
{
    return imp_;
}
