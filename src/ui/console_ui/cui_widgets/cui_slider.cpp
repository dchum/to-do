    ...
    slider_(nullptr)
{
    ...
    slider_ = newCDKSlider(static_cast<CUIScreen*>(parent->screen())->get(), 
                            x, y, *title.get_msg(), *label.get_msg(), fillerCharacter,
                            fieldWidth, currentValue, lowValue, highValue, increment, fastIncrement, box, shadow);
