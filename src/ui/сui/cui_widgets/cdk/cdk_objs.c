 ...
 */
void setCDKWidgetBackgroundColor (CDKOBJS *obj, const char *color)
{
   chtype *holder = NULL;
   int junk1, junk2;
 ...
 */
void setCDKWidgetPreProcess (CDKOBJS *obj, PROCESSFN fn, void *data)
{
 ...
 */
void setCDKWidgetPostProcess (CDKOBJS *obj, PROCESSFN fn, void *data)
{
