...
DeclareCDKWidgets (HISTOGRAM, Histogram, setCdk, Unknown);
			       ...
			       boolean shadow)
{
   ...
   if ((widget = newCDKWidget (CDKHISTOGRAM, &my_funcs)) == NULL)
        return (NULL);
   ...
   registerCDKWidget (cdkscreen, vHISTOGRAM, widget);
...
static void _destroyCDKHistogram (CDKOBJS *object)
{
   if (object != NULL)
   {
      ...
      cleanCDKWidgetBindings (vHISTOGRAM, widget);

      /* Unregister this object. */
      unregisterCDKWidget (vHISTOGRAM, widget);
   }
}
